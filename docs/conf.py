...
project = u'crud-users'
project_pretty_name = u'Crud Users'
copyright = u'%d, Friends of Cake' % datetime.datetime.now().year
version = '1.0'
release = '1.0'
html_title = 'Crud Users'
html_context = {
...
htmlhelp_basename = 'crud-users'
latex_documents = [
    ('index', 'crud-users.tex', u'crud-users',
     u'Friends Of Cake', 'manual'),
]
man_pages = [
    ('index', 'crud-users', u'Crud Users Documentation',
     [u'Friends Of Cake'], 1)
]

texinfo_documents = [
    ('index', 'crud-users', u'Crud Users Documentation',
     u'Friends Of Cake', 'crud-users', 'User Action classes for CakePHP',
     'Miscellaneous'),
]
